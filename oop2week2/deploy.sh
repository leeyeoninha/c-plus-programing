...
# ==================================================================
#  C++ 03장(포인터와 메모리 구조) 확인 학습 퀴즈 — GitHub Pages 수동 배포 스크립트
# ==================================================================
...
#
#  예시:
#    ./deploy.sh https://github.com/your-id/oop2week2.git
#    ./deploy.sh git@github.com:your-id/oop2week2.git
# ==================================================================
...
if [ -z "$REPO_URL" ]; then
  ...
  echo "예시:   ./deploy.sh https://github.com/your-id/oop2week2.git"
  exit 1
fi
...
git -c user.name="deploy-bot" -c user.email="deploy-bot@users.noreply.github.com" \
    commit -q -m "Deploy: C++ 03장 포인터와 메모리 구조 퀴즈 ($(date +'%Y-%m-%d %H:%M'))"
